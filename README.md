...
- создавать, читать, обновлять и удалять проекты;
- создавать, читать, обновлять и удалять задачи;
- назначать задачи пользователям;
- добавлять к задачам теги;
- анализировать текст задачи и сохранять краткое описание;
- отдавать понятные ошибки с корректными HTTP-статусами.
